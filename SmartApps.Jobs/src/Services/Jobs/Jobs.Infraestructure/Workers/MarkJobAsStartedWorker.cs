...
public class MarkJobAsStartedWorker : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<MarkJobAsStartedWorker> _logger;

    public MarkJobAsStartedWorker(
        IServiceProvider serviceProvider,
        ILogger<MarkJobAsStartedWorker> logger)
    {
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        var queue = "SmartApps.Jobs.MarkJobAsStarted";
        var exchange = "Jobs.JobStarted";
    ...
    private async Task HandleMessage(string payload, IServiceScope scope, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var command = payload.FromJson<MarkJobAsStartedCommand>();
            if (command == null) 
            {
                return;
            }
